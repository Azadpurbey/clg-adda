            ...
            <div className='card mt-3'>
              <ul className='list-group list-group-flush'>
                <li className='list-group-item d-flex justify-content-between align-items-center flex-wrap'>
                  ...
                  <a className='text-secondary' href={user.linkedIn}>
                    {user.linkedIn}
                  </a>
                </li>
                ...
                <li className='list-group-item d-flex justify-content-between align-items-center flex-wrap'>
                  ...
                  <a className='text-secondary' href={user.twitter}>
                    {user.twitter}
                  </a>
                </li>
                ...
                <li className='list-group-item d-flex justify-content-between align-items-center flex-wrap'>
                  ...
                  <a className='text-secondary' href={user.instagram}>
                    {user.instagram}
                  </a>
                </li>
                ...
                <li className='list-group-item d-flex justify-content-between align-items-center flex-wrap'>
                  ...
                  <a className='text-secondary' href={user.facebook}>
                    {user.facebook}
                  </a>
                </li>
              </ul>
